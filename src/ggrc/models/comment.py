...
class Commentable(object):
  ...
  _aliases = {
      ...
      "comments": {
          ...
          "description": u'DELIMITER=";;" double semi-colon separated values. '
                         u'To mention person at the comment use the following '
                         u'format <a href="mailto:some_user@example.com"\\> .',
      },
  }
  _fulltext_attrs = [
