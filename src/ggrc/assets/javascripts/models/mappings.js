...
;(function(GGRC, can) {
  ...
  can.Construct("GGRC.Mappings", {
    ...
    get_canonical_mapping : function(object, option) {
      return can.reduce(this.modules, function(mapping, mod, name) {
        var mapping_name;
        if (mapping) return mapping;
        else if (mod._canonical_mappings[object][option]) {
          return CMS.Models[object].get_mapper(mod._canonical_mappings[object][option]);
        }
        else return null;
      }, null);
    },
