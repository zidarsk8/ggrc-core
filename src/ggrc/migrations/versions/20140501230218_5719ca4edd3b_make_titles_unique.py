...
def downgrade():
    op.drop_constraint('uq_t_systems', 'systems')
    op.drop_constraint('uq_requests', 'requests')
    op.drop_constraint('uq_t_projects', 'projects')
    op.drop_constraint('uq_t_programs', 'programs')
    op.drop_constraint('uq_t_products', 'products')
    op.drop_constraint('uq_t_org_groups', 'org_groups')
    op.drop_constraint('uq_t_objectives', 'objectives')
    op.drop_constraint('uq_t_markets', 'markets')
    op.drop_constraint('uq_t_facilities', 'facilities')
    op.drop_constraint('uq_t_directives', 'directives')
    op.drop_constraint('uq_t_data_assets', 'data_assets')
    op.drop_constraint('uq_t_controls', 'controls')
    op.drop_constraint('uq_t_audits', 'audits')
