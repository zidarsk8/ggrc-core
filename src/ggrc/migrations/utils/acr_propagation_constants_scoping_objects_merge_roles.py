...
GGRC_TO_DELETE_ROLES_PROPAGATION = {
    "AccessGroup": TO_DELETE_ROLES_PROPAGATION,
    "DataAsset": TO_DELETE_ROLES_PROPAGATION,
    "Facility": TO_DELETE_ROLES_PROPAGATION,
    "Market": TO_DELETE_ROLES_PROPAGATION,
    "Metric": TO_DELETE_ROLES_PROPAGATION,
    "OrgGroup": TO_DELETE_ROLES_PROPAGATION,
    "Process": TO_DELETE_ROLES_PROPAGATION,
    "Product": TO_DELETE_ROLES_PROPAGATION,
    "ProductGroup": TO_DELETE_ROLES_PROPAGATION,
    "Project": TO_DELETE_ROLES_PROPAGATION,
    "System": TO_DELETE_ROLES_PROPAGATION,
    "TechnologyEnvironment": TO_DELETE_ROLES_PROPAGATION,
    "Vendor": TO_DELETE_ROLES_PROPAGATION,
}
