...
def add_additional_sorting(order_by):
  """Add additional sorting attribute
...
def apply_order_by(model, query, order_by, tgt_class):
  ...
  """
  ordering = add_additional_sorting(order_by)
  join_pairs = [
