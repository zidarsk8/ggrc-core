...
export default can.Control.extend({
  defaults: {
    preload_view: GGRC.templates_path + '/dashboard/modal_preload.mustache',
    header_view: GGRC.templates_path + '/modals/modal_header.mustache',
    custom_attributes_view:
    GGRC.templates_path + '/custom_attributes/modal_content.mustache',
    button_view: null,
