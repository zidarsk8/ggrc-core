...
const userRolesModalSelector = can.Control.extend({
  defaults: {
    base_modal_view:
      GGRC.templates_path + '/people_roles/base_modal.mustache',
    option_column_view:
      GGRC.templates_path + '/people_roles/option_column.mustache',
    object_detail_view:
      GGRC.templates_path + '/people_roles/object_detail.mustache',
