  ...
  def decline_proposal(self, test_data, selenium):
    ...
    if test_data["proposal_to_decline"].status == object_states.PROPOSED:
      ...
      proposal_ui_facade.decline_proposal(
          selenium, test_data["control"], test_data["proposal_to_decline"])
