...
"""Module containing css selectors..
"""
...
class Login(object):
  """Css selector used on login page.
  """
  BUTTON_LOGIN = (By.CSS_SELECTOR, "a.btn.btn-large.btn-info")


class PageHeader(object):
  """Css selector for page header elements.
  """
...
class LhnMenu(object):
  """Css selector for elements in the left hand navigation menu.
  """
  LHN_MENU = (By.ID, "lhn")
