...
class AssessmentTest(base.BaseTaskSet):
  ...
  @locust.task(1)
  def joined_related_query_1(self):
  ...
  @locust.task(1)
  def joined_related_query_2(self):
    """Get all objects related to an assessment in a single request."""
    assessment = generator.random_object("Assessment", self.objects)
    assessment_id = str(assessment["id"])
  ...
  @locust.task(1)
  def joined_related_query_3(self):
    """Get all objects related to an assessment in a single request."""
    assessment = generator.random_object("Assessment", self.objects)
    assessment_id = str(assessment["id"])
  ...
  @locust.task(1)
  def joined_related_query_4(self):
    """Get all objects related to an assessment in a single request."""
    assessment = generator.random_object("Assessment", self.objects)
    assessment_id = str(assessment["id"])
  ...
  @locust.task(1)
  def joined_related_query_5(self):
    """Get all objects related to an assessment in a single request."""
    assessment = generator.random_object("Assessment", self.objects)
    assessment_id = str(assessment["id"])
