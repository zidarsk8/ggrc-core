...
"""
Test if Global Reader role has the permission to access the workflow objects,
owned by Admin.
"""
...
class GlobalReaderTest(WorkflowRolesTestCase):

  def setUp(self):
    super(GlobalReaderTest, self).setUp()
