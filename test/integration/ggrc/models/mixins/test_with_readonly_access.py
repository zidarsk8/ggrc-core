...
@ddt.ddt
class TestWithReadOnlyAccessCAV(TestCase):
  """Test WithReadOnlyAccess mixin"""

  def setUp(self):
    super(TestWithReadOnlyAccessCAV, self).setUp()
    self.object_generator = ObjectGenerator()
    self.object_generator.api.login_as_normal()
  ...
  @ddt.data('System')
  def test_post_not_all_mandattory_cavs_external(self, obj_type):
    """Test POST not all cavs for {0!r} are specified for external user"""
