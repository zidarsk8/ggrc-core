...
class TestMegaProgram(TestCase):
  ...
  def test_program_relatives(self):
    ...
    parents_b = program_b.all_relatives_ids("parents")
    children_b = program_b.all_relatives_ids("children")
    parents_e = program_e.all_relatives_ids("parents")
    children_e = program_e.all_relatives_ids("children")
