...
@ddt.ddt
class TestProgramEditorsPropagation(base.TestACLPropagation):
  """Test Program Editors role permissions propagation"""
  ...
  def init_factory(self, role, model, parent):
    """Initialize RBAC factory with propagated Program Editors role.
  ...
  def test_access(self, role, model, action_name, expected_result):
    """Program Editors {0:<7}: On {1:<20} test {2:<20} - Expected {3:<2} """
